...
do_Str:                        		; do_Str function definition - functions are defined as labels
	...
	cmp byte[ecx], "	"     ; tab ascii dec 9
	je SPACEANDTAB
	cmp byte[ecx], " " ; space ascii dec 9
	je SPACEANDTAB ;if space or tab then the flag is 1
	jmp incChar 


	SPACEANDTAB:
		mov byte[ecx], "_" ;convert to "_" ascii dec 95
		inc dword[an] ;counter ++
		jmp incChar ;inc function
